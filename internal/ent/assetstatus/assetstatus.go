...
const (
	// Label holds the string label denoting the assetstatus type in the database.
	Label = "asset_status"
	...
	// Table holds the table name of the assetstatus in the database.
	Table = "asset_statuses"
)

// Columns holds all SQL columns for assetstatus fields.
var Columns = []string{
	FieldID,
	FieldCompanyID,
	FieldName,
...
// OrderOption defines the ordering options for the AssetStatus queries.
